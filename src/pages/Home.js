...
export default class Home extends Component {
    ...
    componentDidMount(){
        ...
        gsap.from([...head, ...about, ...contact], 1.25, { delay: 0.25, ease: Power3.easeOut, opacity: 0, y: 50, stagger:{ amount: 0.75 } })

        // contact links
        const links = this.refs.contact_links.children
        gsap.from(links, .6, { delay: 1.25, ease: Power3.easeOut, y: 50, opacity: 0, stagger:{ amount: 0.5 } })
    }
                ...
                <div className='center'>
                    ...
                    <div className='contact'>
                        ...
                        <div ref='contact_links' className='links'>
                            ...
                            <a href='../assets/pdf/cv.pdf' title='email'>Resume</a>
                        </div>
                    </div>
                </div>
            </div>
